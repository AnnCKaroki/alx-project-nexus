...
export default function SharePoll({ pollId, pollTitle, isOpen, onClose }: SharePollProps) {
  ...
  // Generate QR code when component mounts or pollId changes
  useEffect(() => {
    if (pollUrl) {
    ...
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50 flex items-center justify-center">
      <div ref={modalRef} className="bg-white rounded-lg shadow-lg max-w-md w-full mx-4">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h3 className="text-lg font-semibold text-gray-900">Share Poll</h3>
          <button
            onClick={onClose}
        ...
        <div className="p-6">
          <div className="mb-4">
            <h4 className="font-medium text-gray-900 mb-2">&ldquo;{pollTitle}&rdquo;</h4>
            <p className="text-sm text-gray-600">
              Share this poll with others to gather more votes and opinions.
            </p>
          </div>
          ...
          <div className="flex bg-gray-100 rounded-lg p-1 mb-6">
            ...
            >
              <svg className="h-4 w-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 16h4.01M16 12h4.01M8 16h2.99M8 8h2.99M12 8h4.01M16 8h4.01" />
              </svg>
              QR Code
            </button>
          </div>
          ...
          {shareMethod === 'link' ? (
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Scan this QR code with a mobile device to access the poll
              </p>
              <button
        ...
        <div className="px-6 py-4 border-t border-gray-200 bg-gray-50 rounded-b-lg">
          <p className="text-xs text-gray-500 text-center">
            Anyone with this link can view and vote on the poll
          </p>
        </div>
      </div>
    </div>
