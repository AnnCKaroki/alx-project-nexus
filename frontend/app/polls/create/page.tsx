...
export default function CreatePollPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Validate that we received a valid poll with an ID
      if (!newPoll || !newPoll.id) {
        console.error('Invalid poll response:', newPoll);
        setSuccessMessage('Poll created successfully! Redirecting to polls list...');
        // Redirect to polls list as fallback
